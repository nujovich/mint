...
import { detectColorSpace } from './css-values.mjs'
 ...
 *
 * @param {string} css - Raw CSS source
 * @returns {{ legacyCount: number, wideGamutCount: number, adoptionRate: number, samples: Array<{value: string, format: string, category: string, selector: string}>, legacyCandidates: Array<{value: string, format: string, category: string, selector: string}> }}
 */
